...
public class UserDataBeans implements Serializable{
    ...
    public void UD2DTOMapping(UserDataDTO udd){
        ...
        //uddにidを追加
        udd.setUserID(this.id);
    }
    
    public void UserDataBeans(UserDataDTO udd){
        Calendar birthday = Calendar.getInstance();
        birthday.setTime(udd.getBirthday());
        this.name=udd.getName();
        this.year=birthday.get(birthday.YEAR);
        this.month=birthday.get(birthday.MONTH)+1;
        this.day=birthday.get(birthday.DAY_OF_MONTH);
